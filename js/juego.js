...
var instrucciones = ['Arrastrar','Soltar', 'Mover'];
...
function chequearSiGano() {
 ...
 if (grilla[0].indexOf(1) === 0 && grilla[0].indexOf(2) === 1 && grilla[0].indexOf(3) === 2 &&
  grilla[1].indexOf(4) === 0 && grilla[1].indexOf(5) === 1 && grilla[1].indexOf(6) === 2 &&
  grilla[2].indexOf(7) === 0 && grilla[2].indexOf(8) === 1 && grilla[2].indexOf(9) === 2 ){
    return true;
  }
    return false;
}
...
function intercambiarPosicionesGrilla(filaPos1, columnaPos1, filaPos2, columnaPos2) {
  ...
  let grillaTemp = grilla[filaPos1][columnaPos1];
